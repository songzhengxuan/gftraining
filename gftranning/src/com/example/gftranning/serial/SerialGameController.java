...
public class SerialGameController {
    ...
    public void updateFromGameActivityResult(Context context, int resultCode, Intent data) {
        ...
        mTotalCorrectTimeInSerial += data.getIntExtra(GameActivity.RESULT_KEY_TEST_CORRECT, 0);
        mTotalTestTimeInSerial += data.getIntExtra(GameActivity.RESULT_KEY_TEST_TOTAL, 0);
        mSerialGameProgress += 1;
